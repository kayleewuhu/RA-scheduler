...
if __name__ == '__main__':
  ras = [RaAvailability("Kari", [date(2024, 1, 13), date(2024, 1, 14)], [DaysOfWeek.WEDNESDAY]),
         ...
         RaAvailability("Luke", distribution=Distribution.FRONTLOAD),
         ...
         RaAvailability("Nico", distribution=Distribution.FRONTLOAD),
         ...
         RaAvailability("Kaylee", distribution=Distribution.BACKLOAD),
         ...
         RaAvailability("David", distribution=Distribution.BACKLOAD),
